...
import { SettingsReadAloudRouteScreen } from "./features/settings/SettingsReadAloudRouteScreen";
...
const SettingsContentStack = createNativeStackNavigator({
  ...
  screens: {
    ...
    SettingsReadAloud: createNativeStackScreen({
      screen: SettingsReadAloudRouteScreen,
      linking: "read-aloud",
      options: {
        title: "Read Aloud",
      },
