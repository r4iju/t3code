...
import { UsageLimitResumeAction, UsageLimitResumeBanner } from "./chat/UsageLimitResumeBanner";
          ...
          >
            ...
            <div className="pointer-events-none absolute inset-x-0 top-0 z-20 flex flex-col">
              ...
              <ThreadErrorBanner
                ...
                action={
                  usageLimitResume ? <UsageLimitResumeAction {...usageLimitResume} /> : undefined
                }
                onDismiss={() => {
                  setThreadError(activeThread.id, null);
