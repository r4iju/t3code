...
| Terminal paste no longer doubles when the clipboard read wins  | `de8ff28dc` (#29)                        | Upstream bug [pingdotgg/t3code#13346](https://github.com/pingdotgg/t3code/issues/13346), PR offered; branch `fix/terminal-double-paste-upstream` is cut from `upstream/main`. Drop the delta once upstream lands a fix.                                                                                                                                                                                                        | **Issue filed** — waiting for opt-in                     |
